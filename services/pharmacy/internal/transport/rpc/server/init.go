...
import (
	...
	"github.com/ritchieridanko/apotekly/services/pharmacy/internal/transport/rpc/interceptors"
...
func Init(cfg *configs.GRPCServer, l *logger.Logger, ph *handlers.PharmacyHandler) *Server {
	srv := grpc.NewServer(
		grpc.StatsHandler(
	...
	apis.RegisterPharmacyServiceServer(srv, ph)
