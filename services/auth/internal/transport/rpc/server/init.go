...
import (
	...
	"github.com/ritchieridanko/apotekly/services/auth/internal/transport/rpc/interceptors"
...
func Init(cfg *configs.GRPCServer, l *logger.Logger, ah *handlers.AuthHandler) *Server {
	srv := grpc.NewServer(
		grpc.StatsHandler(
