...
func (x *ConfirmPasswordResetRequest) GetPasswordResetToken() string {
	if x != nil {
...
const file_v1_auth_api_proto_rawDesc = "" +
	...
	"\x04auth\x18\x01 \x01(\v2\r.auth.v1.AuthR\x04auth\x121\n" +
	"\n" +
	"auth_token\x18\x02 \x01(\v2\x12.auth.v1.AuthTokenR\tauthToken\"M\n" +
	...
	"\x1bConfirmPasswordResetRequest\x120\n" +
