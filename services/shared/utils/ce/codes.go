...
const (
	...
	CodePharmacyAlreadyExists   errCode = "ERR_PHARMACY_ALREADY_EXISTS"
...
const (
	...
	MsgPharmacyAlreadyExists  string = "Pharmacy profile already exists"
	MsgPharmacyNotFound       string = "Pharmacy profile not found"
