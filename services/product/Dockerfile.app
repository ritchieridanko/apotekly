...
COPY services/product/cmd/app ./cmd/app
COPY services/product/configs ./configs
COPY services/product/internal ./internal
...
COPY --from=builder /app/product/bin ./bin
COPY --from=builder /app/product/configs ./configs
