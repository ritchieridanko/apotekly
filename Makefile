...
docker-migrator-up:
	...
	docker compose run --rm pharmacy-migrator -up
	docker compose run --rm product-migrator -up
...
docker-migrator-down:
	...
	docker compose run --rm pharmacy-migrator -down 0
	docker compose run --rm product-migrator -down 0
